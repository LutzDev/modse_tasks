 ...
 * </p>
 * <ul>
 *   <li>{@link jSON.impl.ArrayImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayImpl extends ValueImpl implements Array {
	...
	public EList<Value> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<Value>(Value.class, this, JSONPackage.ARRAY__VALUE);
		}
		return value;
	}

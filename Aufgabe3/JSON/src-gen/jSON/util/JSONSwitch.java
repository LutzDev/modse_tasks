...
public class JSONSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case JSONPackage.ARRAY: {
			...
			if (result == null)
				result = caseValue(array);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case JSONPackage.STRING: {
			jSON.String string = (jSON.String) theEObject;
		...
		case JSONPackage.NUMBER: {
			jSON.Number number = (jSON.Number) theEObject;
		...
		case JSONPackage.OBJECT: {
			jSON.Object object = (jSON.Object) theEObject;
			T result = caseObject(object);
			if (result == null)
				result = caseValue(object);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case JSONPackage.SPECIAL_TYPE: {
			SpecialType specialType = (SpecialType) theEObject;
			T result = caseSpecialType(specialType);
			if (result == null)
				result = caseValue(specialType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseString(jSON.String object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseNumber(jSON.Number object) {
		return null;
	}
